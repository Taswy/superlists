...
class NewItemTest(TestCase):
    def test_cen_save_a_POST_request_to_an_existing_list(self):
    ...
    def test_redirects_to_list_view(self):
        ...
        respose = self.client.post('/lists/%d/add_item' % (correct_list.id),
                                   data={'item_text': 'A new item for an existing list'})

        self.assertRedirects(respose, 'lists/%d/' % (correct_list.id,))
